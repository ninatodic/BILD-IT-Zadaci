...
public class RationalBI extends Number implements Comparable<RationalBI>{
	// Data fields for numerator and denominator
		...
		public RationalBI subtract(RationalBI o) {
			BigInteger n = (r[0].multiply(o.getDenominator())).subtract(
				r[1].multiply(o.getNumerator()));
			BigInteger d = r[1].multiply(o.getDenominator());
			return new RationalBI(n, d);
		}
		...
		public int compareTo(RationalBI o) {
			...
			BigInteger n = this.subtract((RationalBI)o).getNumerator();
